...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param   amountCollateral  The amount of collateral to rededem.
    ...
    // Health factor must be over 1 after collateral being pulled
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) nonReentrant {
        ...
        _revertIfHealtFactorIsBroken(msg.sender); // Probably not needed
    }
    ...
    * @notice: A known bug would be if the protocol was only 100% collateralized, we wouldn't be able to liquidate
    ...
    /**
     * @dev Don't call unless the function calling it is checking if the health factor is broken
     */
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        // 1ETH = 1000$
        // The returned value from the price feed is 1000 * 10e8
